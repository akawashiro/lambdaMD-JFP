...
literature~\cite{Kisekyov2018Reconciling,Mainland2012MetaHaskell,Taha2007Gentle}.

% MetaOCaml

MetaOCaml~\cite{CalcagnoTahaHuangKeroy2003Implementing,Kisekyov2014BERMetaOCaml} is an extension of
...
beyond simple types.  For example, Kiselyov~\cite{Kisekyov2018Reconciling} demonstrates
