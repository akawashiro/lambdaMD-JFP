...
Davies~\cite{Davis1996Temporal}, who found Curry-Howard correspondence
...
dependent type systems such as $\lambda^\Pi$~\cite{MeyerReinhold1986Type}, The Calculus of
Constructions~\cite{Coquand1988CoC}, and Edinburgh
LF~\cite{HarperHonsellPlotkin1993Framework}, we base our work on \LLF~\cite{attapl} (which is
