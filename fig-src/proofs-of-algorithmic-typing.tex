...
\begin{proof}
    ...
    \begin{rneqncase}{\QAANF}{
            ...
            \ANF(M) \E_\alpha \ANF(N),
            \G \AVS M : \tau @ A,
            \G \AVS N : \tau' @ A \text{ and }
            \G \AVS \tau \E \tau' @ A
        }
        \AK{TODO after Agreement}
        ...
        %
        % Apply Lemma \ref{lemma:AlgorithmicTypePreservationofAlgorithmicReduction} to \( \G \AVS M, N : \tau @ A \), \( \G \AVS \ANF(M), \ANF(N) : \tau @ A \).
